...
namespace clang {
  ...
  enum MetaobjectConcept  {
    ...
    MOC_ScopeMember              = (1UL <<  5U) | MOC_Object,
    MOC_Base                     = (1UL <<  6U) | MOC_Object,
    MOC_Template                 = (1UL <<  7U) | MOC_Object,
    MOC_Expression               = (1UL <<  8U) | MOC_Object,
    ...
    MOC_Variable                 = (1UL << 13U) | MOC_Named | MOC_Typed | MOC_ScopeMember,
    MOC_FunctionParameter        = (1UL << 14U) | MOC_Typed | MOC_ScopeMember,
    MOC_Namespace                = (1UL << 15U) | MOC_Named | MOC_Scope | MOC_ScopeMember,
    ...
    MOC_SpecialMemberFunction    = (1UL << 26U) | MOC_RecordMember,
    MOC_Constructor              = (1UL << 27U) | MOC_Callable | MOC_RecordMember,
    MOC_Destructor               = (1UL << 28U) | MOC_Callable | MOC_SpecialMemberFunction,
    MOC_Operator                 = (1UL << 29U) | MOC_Function,
    MOC_ConversionOperator       = (1UL << 30U) | MOC_RecordMember | MOC_Operator,
    MOC_Lambda                   = (1UL << 31U) | MOC_Type | MOC_Scope,
    MOC_LambdaCapture            = (1UL << 32U) | MOC_Variable,
    MOC_ParenthesizedExpression  = (1UL << 33U) | MOC_Expression,
    MOC_FunctionCallExpression   = (1UL << 34U) | MOC_Expression,
    MOC_FunctionalTypeConversion = (1UL << 35U) | MOC_Expression,
    MOC_Specifier                = (1UL << 36U) | MOC_Named,
    ...
    MOC_MemberFunction           = MOC_RecordMember | MOC_NamedFunction,

...
namespace clang {
  ...
  enum MetaobjectConcept  {
    MOC_Object            = (1 <<  0),
    MOC_ObjectSequence    = (1 <<  1) | MOC_Object,
    MOC_Named             = (1 <<  2) | MOC_Object,
    MOC_Typed             = (1 <<  3) | MOC_Object,
    MOC_Scope             = (1 <<  4) | MOC_Object,
    MOC_ScopeMember       = (1 <<  5) | MOC_Object,
    MOC_Base              = (1 <<  6) | MOC_Object,
    MOC_Template          = (1 <<  7) | MOC_Object,
    MOC_Parameter         = (1 <<  8) | MOC_Object,
    ...
    MOC_Function          = (1 << 21) | MOC_Scope | MOC_ScopeMember,
    MOC_Specifier         = (1 << 22) | MOC_Named,

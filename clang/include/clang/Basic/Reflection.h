...
namespace clang {
  ...
  enum MetaobjectConcept  {
	...
	MOC_ParenthesizedExpression  = (1UL << 31U) | MOC_Expression,
	MOC_FunctionCallExpression   = (1UL << 32U) | MOC_Expression,
	MOC_FunctionalTypeConversion = (1UL << 33U) | MOC_Expression,
    MOC_Specifier                = (1UL << 34U) | MOC_Named,
